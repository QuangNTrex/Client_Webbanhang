        ...
        <div className="CartPage">
            ...
            <div className="wrap-bottom">
                ...
                <div className="wrap-bottom-right">
                    <h3 className="title">Tổng cộng {'('}{cart.reduce((total, item) => total + item.quantity, 0) || 0} sản phẩm {')'}: </h3>
                    <h3 className="total-price">{cart.reduce((total, item) => total + item.quantity * item.product.price * item.checked, 0) || 0} VND</h3>
